          ...
          <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
            ...
            <div className="p-5">
              <div className="grid grid-cols-1 gap-1">
                  <a href={process.env.NEXT_PUBLIC_URL + '/connect/github'} className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Login with Github</a>
              </div>
            </div>
            <div className="py-5">
